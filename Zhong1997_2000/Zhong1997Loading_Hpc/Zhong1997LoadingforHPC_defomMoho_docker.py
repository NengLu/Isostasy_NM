...
#type_bcs = "_LithoBot"
fdir_output = "DefrmMoho_Loading"+ type_bcs +"_resx480"
...
conditions = uw.conditions.DirichletCondition(variable=TField,indexSetsPerDof=(top + bottom + interface,))
...
if interface:
    TField.data[interface.data, 0] = init_mesh.data[interface.data][:,1]
